      ...
      <div className="row g-5">
        ...
        <div className="col-md-6 col-lg-3">
          ...
          <div className="row g-2">
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-1.jpg" alt="Image" />
            </div>
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-2.jpg" alt="Image" />
            </div>
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-3.jpg" alt="Image" />
            </div>
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-4.jpg" alt="Image" />
            </div>
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-5.jpg" alt="Image" />
            </div>
            <div className="col-4">
              <Image className="img-fluid" src="/img/portfolio-6.jpg" alt="Image" />
            </div>
          </div>
        </div>
        <div className="col-md-6 col-lg-3">
      ...
      <div className="copyright">
        <div className="row">
          <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
            © <a className="border-bottom" href="#">rayonweb</a>, All Right Reserved. 
            {/*/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. *** /*/}
            Designed By <a className="border-bottom" href="https://rayonweb.com">rayonweb</a>
          </div>
